<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"D:\work\kanyun\public/../application/admin\view\dashboard\index.html";i:1535692925;s:57:"D:\work\kanyun\application\admin\view\layout\default.html";i:1533742465;s:54:"D:\work\kanyun\application\admin\view\common\meta.html";i:1533742465;s:56:"D:\work\kanyun\application\admin\view\common\script.html";i:1533742465;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="col-xs-6 col-md-3">
                        <div class="panel bg-red">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    <h1 class="no-margins"><?php echo $two; ?></h1>
                                    <!--<div class="stat-percent font-bold text-gray"><i class="fa fa-modx"></i> 2592</div>-->
                                    <small>当前发布二级目录数</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-3">
                        <div class="panel bg-yellow">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    <h1 class="no-margins"><?php echo $three; ?></h1>
                                    <!--<div class="stat-percent font-bold text-gray"><i class="fa fa-modx"></i> 2592</div>-->
                                    <small>当前发布三级目录数</small>
                                </div>
                            </div>
                        </div>
                    </div>
