<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"D:\work\kanyun\public/../application/admin\view\article\add.html";i:1535609657;s:57:"D:\work\kanyun\application\admin\view\layout\default.html";i:1533742465;s:54:"D:\work\kanyun\application\admin\view\common\meta.html";i:1533742465;s:56:"D:\work\kanyun\application\admin\view\common\script.html";i:1533742465;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-pid" data-rule="required" class="form-control form-control" name="row[pid]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-level" data-rule="required" class="form-control selectpicker" name="row[level]">
                <?php if(is_array($levelList) || $levelList instanceof \think\Collection || $levelList instanceof \think\Paginator): if( count($levelList)==0 ) : echo "" ;else: foreach($levelList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"one"))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-title" data-rule="required" class="form-control form-control" name="row[title]" type="text" value="未定义">
        </div>
    </div>
    <div class="form-group">
